      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-10">
        ...
        >
          ...
          <div
            ...
            style={{ left: '50%' }}
          >
            <div className="absolute top-1/2 -translate-y-1/2 -translate-x-1/2 w-12 h-12 rounded-full bg-white shadow-2xl flex items-center justify-center pointer-events-auto cursor-col-resize z-20">
